                                    ...
                                    <div class="d-flex flex-row align-items-center mb-4">
                                        ...
                                        <div class="form-outline flex-fill mb-0">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <form:label class="form-label me-2" path="gender">男</form:label>
                                                <form:radiobutton class="form-radio-input me-2" path="gender" value="0" />
                                                <form:label class="form-label me-2" path="gender">女</form:label>
                                                <form:radiobutton class="form-radio-input me-2" path="gender" value="1" />
                                                <form:label class="form-label me-2" path="gender">不透露</form:label>
                                                <form:radiobutton class="form-radio-input" path="gender" value="2" />
                                            </div>
